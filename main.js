...
let para = "Esther"; // valor por defecto
let mensaje = "Te amo y no es un amor que haya sentido antes es un amor unico que solo he logrado sentir contigo.\n Me haces sentir tan especial que siempre que pienso en ti me pongo muy feliz. \n\n Pero aveces siento que no soy el indicado para ti :( porque te lastimo o te hago sentir mal. \n Pero quiero que sepas que lo que siento por ti es real y es verdadero y sincero, te amo con todo mi corazón y te pido perdon por todo el mal que aveces te hago, creeme que no es mi intención, yo siempre quiero que estes feliz y contenta.\n TE AMO MUCHO NUNCA PIENSES LO CONTRARIO AMOR, SOLO TÚ ERES MI ÚNICO AMOR";
...
let loadingText = "Para ti AMOR:"; // valor por defecto para loading
